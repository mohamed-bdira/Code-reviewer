...
- "bugs": array of objects for concrete issues to store (use [] if none). Each object: "category" (e.g. security, bug, style, usability), "file" (repo-relative path), optional "lineStart" and "lineEnd" (1-based line numbers in the new file if known), "description" (short text).
